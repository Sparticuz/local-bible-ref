...
| `inline`, `i`         | Wraps the passage in quotation marks and follows it with a linked source reference, for use within surrounding prose.                             | `"&lt;sup&gt;16&lt;/sup&gt; Rejoice always." ([[path\|1 Thessalonians 5:16 - ESV]])`               |
